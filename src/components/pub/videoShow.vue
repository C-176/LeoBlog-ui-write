<template>
  <!-- ====== Video Section Start -->
<!--  <section v-data="{ videoOpen: false}" class="bg-white py-20 lg:py-[120px]">-->
        ...
        <div class="w-full px-4 lg:w-10/12">
          ...
          >
            <div class="absolute top-0 left-0 h-full w-full">
              <img
                  src="https://cdn.tailgrids.com/1.0/assets/images/videos/image-02.jpg"
                  alt="image"
                  class="h-full w-full object-cover object-center"
              />
            </div>
            <div
                class="bg-primary absolute top-0 left-0 z-10 flex h-full w-full items-center justify-center bg-opacity-90"
            >
              <a
